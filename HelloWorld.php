...
<?PHP
	...
	echo "<h2>The source code for this page and its accompanying CSS file is kept on GitHub and updated via the GitHub desktop client.<br>Deployment to the Azure site is synchronised directly from GitHub.</h2><br>";
